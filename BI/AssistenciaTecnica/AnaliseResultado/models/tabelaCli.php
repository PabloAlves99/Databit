<div class="card shadow-sm h-80 border-0">
    <div class="card-body p-0">
        <div class="table-responsive" style="border-radius: 24px;">
            <table class="table table-hover table-sm align-middle m-1 mb-0" id="tabela-clientes">
                ...
                <tbody id="tbody-clientes" style="font-size: 0.9rem;">
                    <tr>
                ...
                <tfoot class="fw-bold bg-light" style="font-size: 0.9rem; position: sticky; bottom: 0;">
                    <tr>
                        <td>Total</td>
                        <td class="text-center" id="tot-os-cli">0</td>
                        <td class="text-center" id="tot-sla-cli">0,00%</td>
                        <td class="text-center" id="tot-prod-cli">00:00:00</td>
                        <td class="text-center" id="tot-desl-cli">00:00:00</td>
                        <td class="text-center" id="tot-pecas-cli">0,00</td>
                        <td class="text-center" id="tot-reinc-cli">0</td>
                        <td class="text-center" id="tot-ret-cli">0</td>
                    </tr>
                </tfoot>
            </table>
        </div>
